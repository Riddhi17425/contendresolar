    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Key Features</h3>
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-md-12 col-lg-12 ">
            <div class="card mb-3 bg-transparent p-2">
                @foreach ($data as $keyfeature)
                <div class="card border-0 mb-1">
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <h6 class="mb-3 fw-bold">{{ $keyfeature->title }} <span
                                    class="text-muted small fw-light d-block">Reference {{ $keyfeature->id }}</span></h6>

                        </div>
                        <div class="ms-auto d-none d-md-flex">
                            <a href="{{ route('keyfeature.edit', $keyfeature) }}" class="btn btn-warning me-2">Edit</a>
                            <form action="{{ route('keyfeature.destroy', $keyfeature) }}" method="POST">
                                @csrf
                                @method('DELETE')
