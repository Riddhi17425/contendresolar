            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" id="input-file-front" name="front_image" class="dropify"
                                            data-default-file="{{ asset('public/news/news_front_image/' . $data->front_image) }}" >
                                    </div>
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" id="input-file-front" name="detail_image" class="dropify"
                                            data-default-file="{{ asset('public/news/news_detail_image/' . $data->detail_image) }}" >
                                    </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold">News Cta Image</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        <label class="form-label" for="input-file-front">News Cta Image Upload</label>
                                        <input type="file" id="input-file-front" name="news_cta_image" class="dropify"
                                            data-default-file="{{ asset('public/news/news_cta_image/' . $data->news_cta_image) }}" >
                                    </div>
                                    @if ($errors->has('news_cta_image'))
                                    <span class="text-danger">{{ $errors->first('news_cta_image') }}</span>
                                    @endif
                                </div>
                            </div>
                        </div> 
