...
@section('title', 'Hiro Section List')
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Hiro Section</h3>

                <div class="row align-items-center mb-3">
                    <div class="col-md-12">
                        <a href="{{ route('hiro.section.create') }}" class="btn btn-primary">Add Hiro Section</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-12 col-lg-12 ">
            <div class="card mb-3 bg-transparent p-2">
               <table id="hirosectionTable" class="table table-hover align-middle mb-0" style="width:100%">
                <thead>
                    <tr>
                        <th scope="col">#</th>
...
@push('scripts')
    <script>
        window.APP_URLS = {
            getHiroSectiondata: "{{ route('getHiroSectionData') }}",
            deletehirosection:"{{ route('hirosection.delete' , [':id']) }}",
    ...
    <script src="{{ asset('public/admin/js/hirosection/hirosection.js') }}"></script>
