            ...
            <div class="col-xl-12 col-lg-8">
                <div class="card mb-3 p-3">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <!-- <div class="col-md-12">
                            <label for="before_image_desc" class="form-label">Before Detail Image Description</label>
                            <textarea id="before_image_desc" name="before_image_desc" class="form-control" ></textarea>
                        </div> -->
                        <div class="col-md-12">
                        ...
                        <!-- <div class="col-md-12">
                            <label for="after_image_desc" class="form-label">After Detail Image Description</label>
                            <textarea id="after_image_desc" name="after_image_desc" class="form-control" ></textarea>
                        </div> -->
                        <div class="col-md-6">
                            <label class="form-label" for="front_image">Blog Cta Image</label>
                            <input type="file" id="blog_cta_image" name="blog_cta_image" class="form-control">
                        </div>
                        <div class="col-md-12">
                        ...
                        <div id="faqRepeater">
                            <div class=" row g-3 align-items-center faqGroup border p-3 mb-4 rounded">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea  name="faq_description[]" class="form-control summernote" required></textarea>
                                    </div>
                        ...
                        <div class="mb-3">
                            <button type="button" id="addFaqBlock" class="btn btn-success">+ Add More</button>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#addFaqBlock').click(function () {
            let html = `
            <div class="faqGroup border p-3 mb-4 rounded">
                <div class="row g-3">

                    <div class="col-md-6">
                            <label class="form-label">Title</label>
                            <input type="text" id="title" name="faq_title[]" required class="form-control">
                        </div>
                    <div class="col-md-12">
                            <label class="form-label">Description</label>
                            <textarea  name="faq_description[]" class="form-control summernote" required></textarea>
