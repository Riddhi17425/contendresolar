        ...
        <div class="border-0 mb-4">
            <div
                ...
                <div class="btn-group group-link btn-set-task w-sm-100">
                    <a href="{!! backendRoutePut('product-grid') !!}" class="btn d-inline-flex align-items-center"
                        aria-current="page"><i class="icofont-wall px-2 fs-5"></i>Grid View</a>
                    <a href="{!! backendRoutePut('product-list') !!}"
                        class="btn active d-inline-flex align-items-center"><i
                ...
                <div class="card mb-3">
                    <div class="reset-block">
                        ...
                        <div class="filter-btn">
                            <a class="btn btn-primary" href="javascript:void(0);">Reset</a>
                        </div>
                    </div>
                </div>
                <div class="card mb-3">
                        ...
                        <div class="collapse show" id="category">
                            ...
                            <div class="filter-category">
                                <ul class="category-list">
                                    <li><a href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                                            aria-expanded="false" class="collapsed">Game accessories</a>
                                        <ul id="collapseOne" class="sub-category collapse" data-parent="#category">
                                            <li><a href="javascript:void(0);">PlayStation 4</a></li>
                                            <li><a href="javascript:void(0);">Oculus VR</a></li>
                                            <li><a href="javascript:void(0);">Remote</a></li>
                                            <li><a href="javascript:void(0);">Lighting Keyborad</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
                                            data-bs-target="#collapseTwo">Bags</a>
                                        <ul id="collapseTwo" class="sub-category collapse" data-parent="#category">
                                            <li><a href="javascript:void(0);">School Bags</a></li>
                                            <li><a href="javascript:void(0);">Traveling Bags</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
                                            data-bs-target="#collapseThree">Flower Port</a>
                                        <ul id="collapseThree" class="sub-category collapse" data-parent="#category">
                                            <li><a href="javascript:void(0);">Woodan Port</a></li>
                                            <li><a href="javascript:void(0);">Pattern Port</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
                                            data-bs-target="#collapseFour">Watch</a>
                                        <ul id="collapseFour" class="sub-category collapse" data-parent="#category">
                                            <li><a href="javascript:void(0);">Wall Clock</a></li>
                                            <li><a href="javascript:void(0);">Smart Watch</a></li>
                                            <li><a href="javascript:void(0);">Rado Watch</a></li>
                                            <li><a href="javascript:void(0);">Fasttrack Watch</a></li>
                                            <li><a href="javascript:void(0);">Noise Watch</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
                                            data-bs-target="#collapseFive">Accessories</a>
                                        <ul id="collapseFive" class="sub-category collapse" data-parent="#category">
                                            <li><a href="javascript:void(0);">Note Diaries</a></li>
                                            <li><a href="javascript:void(0);">Fold Diaries</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="card mb-3 bg-transparent p-2">
                    ...
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <a href="{!! backendRoutePut('product-detail') !!}">
                            <img class="w120 rounded img-fluid"
                                src="{!! asset('public/backend/dist/assets/images/product/product-1.jpg') !!}" alt="">
                        </a>
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <a href="{!! backendRoutePut('product-detail') !!}">
                                <h6 class="mb-3 fw-bold">Oculus VR <span
                                        class="text-muted small fw-light d-block">Reference 1204</span></h6>
                            </a>
                            <div
                ...
                <div class="card border-0 mb-1">
                    ...
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <a href="{!! backendRoutePut('product-detail') !!}">
                            <img class="w120 rounded img-fluid"
                                src="{!! asset('public/backend/dist/assets/images/product/product-2.jpg') !!}" alt="">
                        </a>
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <a href="{!! backendRoutePut('product-detail') !!}">
                                <h6 class="mb-3 fw-bold">Wall Clock <span
                                        class="text-muted small fw-light d-block">Reference 1004</span></h6>
                            </a>
                            <div
                                class="d-flex flex-row flex-wrap align-items-center justify-content-center justify-content-md-start">
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                ...
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                    <div class="text-muted small">Ratings</div>
                                    <strong><i class="icofont-star text-warning"></i>3.5 <span
                                            class="text-muted">(77)</span></strong>
                                </div>
                            </div>
                            <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2 d-inline-flex d-md-none">
                                <button type="button" class="btn btn-primary">Add Cart</button>
                ...
                <div class="card border-0 mb-1">
                    ...
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <a href="{!! backendRoutePut('product-detail') !!}">
                            <img class="w120 rounded img-fluid"
                                src="{!! asset('public/backend/dist/assets/images/product/product-3.jpg') !!}" alt="">
                        </a>
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <a href="{!! backendRoutePut('product-detail') !!}">
                                <h6 class="mb-3 fw-bold">Note Diaries <span
                                        class="text-muted small fw-light d-block">Reference 1224</span></h6>
                            </a>
                            <div
                                class="d-flex flex-row flex-wrap align-items-center justify-content-center justify-content-md-start">
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                ...
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                    <div class="text-muted small">Ratings</div>
                                    <strong><i class="icofont-star text-warning"></i>3.5 <span
                                            class="text-muted">(98)</span></strong>
                                </div>
                            </div>
                            <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2 d-inline-flex d-md-none">
                                <button type="button" class="btn btn-primary">Add Cart</button>
                ...
                <div class="card border-0 mb-1">
                    ...
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <a href="{!! backendRoutePut('product-detail') !!}">
                            <img class="w120 rounded img-fluid"
                                src="{!! asset('public/backend/dist/assets/images/product/product-4.jpg') !!}" alt="">
                        </a>
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <a href="{!! backendRoutePut('product-detail') !!}">
                                <h6 class="mb-3 fw-bold">Flower Port <span
                                        class="text-muted small fw-light d-block">Reference 1414</span></h6>
                            </a>
                            <div
                                class="d-flex flex-row flex-wrap align-items-center justify-content-center justify-content-md-start">
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                ...
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                    <div class="text-muted small">Ratings</div>
                                    <strong><i class="icofont-star text-warning"></i>4.5 <span
                                            class="text-muted">(1455)</span></strong>
                                </div>
                            </div>
                            <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2 d-inline-flex d-md-none">
                                <button type="button" class="btn btn-primary">Add Cart</button>
                ...
                <div class="card border-0 mb-1">
                    ...
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <a href="{!! backendRoutePut('product-detail') !!}">
                            <img class="w120 rounded img-fluid"
                                src="{!! asset('public/backend/dist/assets/images/product/product-5.jpg') !!}" alt="">
                        </a>
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <a href="{!! backendRoutePut('product-detail') !!}">
                                <h6 class="mb-3 fw-bold">School Bag <span
                                        class="text-muted small fw-light d-block">Reference 1000</span></h6>
                            </a>
                            <div
                                class="d-flex flex-row flex-wrap align-items-center justify-content-center justify-content-md-start">
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                ...
                <div class="card border-0 mb-1">
                    ...
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <a href="{!! backendRoutePut('product-detail') !!}">
                            <img class="w120 rounded img-fluid"
                                src="{!! asset('public/backend/dist/assets/images/product/product-6.jpg') !!}" alt="">
                        </a>
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <a href="{!! backendRoutePut('product-detail') !!}">
                                <h6 class="mb-3 fw-bold">Rado Watch <span
                                        class="text-muted small fw-light d-block">Reference 9204</span></h6>
                            </a>
                            <div
                                class="d-flex flex-row flex-wrap align-items-center justify-content-center justify-content-md-start">
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                ...
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                    <div class="text-muted small">Ratings</div>
                                    <strong><i class="icofont-star text-warning"></i>4.5 <span
                                            class="text-muted">(1245)</span></strong>
                                </div>
                            </div>
                            <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2 d-inline-flex d-md-none">
                                <button type="button" class="btn btn-primary">Add Cart</button>
                ...
                <div class="card border-0 mb-1">
                    ...
                    <div class="card-body d-flex align-items-center flex-column flex-md-row">
                        <a href="{!! backendRoutePut('product-detail') !!}">
                            <img class="w120 rounded img-fluid"
                                src="{!! asset('public/backend/dist/assets/images/product/product-7.jpg') !!}" alt="">
                        </a>
                        <div class="ms-md-4 m-0 mt-4 mt-md-0 text-md-start text-center w-100">
                            <a href="{!! backendRoutePut('product-detail') !!}">
                                <h6 class="mb-3 fw-bold">Traveling Bag <span
                                        class="text-muted small fw-light d-block">Reference 1155</span></h6>
                            </a>
                            <div
                                class="d-flex flex-row flex-wrap align-items-center justify-content-center justify-content-md-start">
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                ...
                                <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2">
                                    <div class="text-muted small">Ratings</div>
                                    <strong><i class="icofont-star text-warning"></i>4.5 <span
                                            class="text-muted">(1045)</span></strong>
                                </div>
                            </div>
                            <div class="pe-xl-5 pe-md-4 ps-md-0 px-3 mb-2 d-inline-flex d-md-none">
                                <button type="button" class="btn btn-primary">Add Cart</button>
