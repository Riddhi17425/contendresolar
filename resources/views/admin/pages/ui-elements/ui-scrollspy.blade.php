    ...
    <div class="col-12">
        <div class="bd-content ps-lg-4">
            ...
            <div class="alert alert-danger" role="alert">
                <strong>Scrollspy</strong> for more bootstrao components <a
                    href="https://v5.getbootstrap.com/docs/5.0/components/scrollspy/" target="_blank">Bootstrap
                    Scrollspy documentation <i class="fa fa-external-link"></i></a>
            </div>
            <ul class="ps-3">
                <li>It must be used on a Bootstrap <a href="https://v5.getbootstrap.com/docs/5.0/components/navs/">nav
                        component</a> or <a href="https://v5.getbootstrap.com/docs/5.0/components/list-group/">list
                        group</a>.</li>
                <li>Scrollspy requires <code>position: relative;</code> on the element you’re spying on, usually the
                    <code>&lt;body&gt;</code>.
                </li>
                <li>Anchors (<code>&lt;a&gt;</code>) are required and must point to an element with that
                    <code>id</code>.
                </li>
            </ul>
            <p>When successfully implemented, your nav or list group will update accordingly, moving the
                <code>.active</code> class from one item to the next based on their associated targets.
            </p>
            <div class="card card-callout p-3">
                ...
                <p class="mb-0">If you’re making a scrollable container (other than the <code>&lt;body&gt;</code>), be
                    sure to have a <code>height</code> set and <code>overflow-y: scroll;</code> applied to it—alongside
                    a <code>tabindex="0"</code> to ensure keyboard access.</p>
            </div>

            <div class="border-top mt-5 pt-3">
                <h5 id="example-in-navbar">Example in navbar</h5>
                <p>Scroll the area below the navbar and watch the active class change. The dropdown items will be
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="nav-Preview1" role="tabpanel">
                                ...
                                <div class="mt-2" data-bs-spy="scroll" data-bs-target="#navbar-example1"
                                    ...
                                    <p>Veniam marfa mustache skateboard, adipisicing fugiat velit pitchfork beard.
                                        ...
                                        freegan vinyl. Lo-fi wes anderson +1 sartorial. Carles non aesthetic
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
                                            tabindex="0" style="height: 345px; overflow-y: auto; position: relative;">
