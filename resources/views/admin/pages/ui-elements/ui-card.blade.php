...
<div class="container">
        ...
        <div class="row justify-content-between">
            <div class="col-lg-8 col-sm-12">
                ...
                <p>Cards are built with as little markup and styles as possible, but still manage to deliver a ton of
                    ...
                    Bootstrap components. They have no <code>margin</code> by default, so use <a
                        href="/docs/5.0/utilities/spacing/">spacing utilities</a> as needed.</p>
                <p>Below is an example of a basic card with mixed content and a fixed width. Cards have no fixed width
                    ...
                    with our various <a href="#sizing">sizing options</a>.</p>
                <div class="bd-example mb-5">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="{!! asset('public/backend/dist/assets/images/gallery/1.jpg') !!}"
                            alt="" />
                        <div class="card-body">
    ...
    <code class="language-html" data-lang="html">&lt;div class=&quot;card&quot; style=&quot;width: 18rem;&quot;&gt;
        &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/1.jpg') !!}&quot; alt=&quot;&quot; /&gt;
        &lt;div class=&quot;card-body&quot;&gt;
            &lt;h5 class=&quot;card-title&quot;&gt;Card title&lt;/h5&gt;
    ...
    &lt;/div&gt;</code>
                ...
                <h3 id="body">Body<a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon="#" href="#body"
    ...
    &lt;/div&gt;</code>
                ...
                <div class="bd-example mb-5">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="{!! asset('public/backend/dist/assets/images/gallery/2.jpg') !!}"
                            alt="" />
                    ...
                    <pre>
    <code class="language-html" data-lang="html">&lt;div class=&quot;card&quot; style=&quot;width: 18rem;&quot;&gt;
        &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/2.jpg') !!}&quot; alt=&quot;&quot; /&gt;
    ...
    &lt;/div&gt;</code>
                ...
                <div class="bd-example mb-5">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="{!! asset('public/backend/dist/assets/images/gallery/6.jpg') !!}"
                            alt="" />
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                    ...
                    <pre>
    <code class="language-html" data-lang="html">&lt;div class=&quot;card&quot; style=&quot;width: 18rem;&quot;&gt;
        &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/6.jpg') !!}&quot; alt=&quot;&quot; /&gt;
        &lt;div class=&quot;card-body&quot;&gt;
            &lt;h5 class=&quot;card-title&quot;&gt;Card title&lt;/h5&gt;
            &lt;p class=&quot;card-text&quot;&gt;Some quick example text to build on the card title and make up the bulk of the card's content.&lt;/p&gt;
        &lt;/div&gt;
    ...
    &lt;/div&gt;</code>
                ...
                <p>Card headers can be styled by adding <code>.card-header</code> to <code>&lt;h*&gt;</code> elements.
                </p>
                <div class="bd-example mb-5">
                    <div class="card">
    ...
    &lt;/div&gt;</code>
                ...
                <h3 id="using-grid-markup">Using grid markup<a class="anchorjs-link " aria-label="Anchor"
                        data-anchorjs-icon="#" href="#using-grid-markup" style="padding-left: 0.375em;"></a></h3>
    ...
    &lt;/div&gt;</code>
                ...
                <p>Use our handful of <a href="https://v5.getbootstrap.com/docs/5.0/utilities/sizing/">available sizing
                        utilities</a> to quickly set a card’s width.</p>
                <div class="bd-example mb-5">
                    <div class="card w-75">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
    ...
    &lt;/div&gt;</code>
                ...
                <p>You can quickly change the text alignment of any card—in its entirety or specific parts—with our <a
                        href="https://v5.getbootstrap.com/docs/5.0/utilities/text/#text-alignment">text align
                        classes</a>.</p>
                <div class="bd-example mb-5">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
    ...
    &lt;/div&gt;</code>
                ...
                <p>Add some navigation to a card’s header (or block) with Bootstrap’s <a
                        href="https://v5.getbootstrap.com/docs/5.0/components/navs/">nav components</a>.</p>
                <div class="bd-example mb-5">
                    <div class="card text-center">
                        <div class="card-header color-bg-100">
                            <ul class="nav nav-tabs card-header-tabs">
                                <li class="nav-item"><a class="nav-link active" aria-current="true" href="javascript:void(0);">Active</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="javascript:void(0);">Link</a></li>
                                <li class="nav-item"><a class="nav-link disabled" href="javascript:void(0);" tabindex="-1"
                    ...
                    <div class="card text-center">
                        <div class="card-header color-bg-100">
                            <ul class="nav nav-pills card-header-pills">
                                <li class="nav-item"><a class="nav-link active" href="javascript:void(0);">Active</a></li>
                                <li class="nav-item"><a class="nav-link" href="javascript:void(0);">Link</a></li>
                                <li class="nav-item"><a class="nav-link disabled" href="javascript:void(0);" tabindex="-1"
                                        aria-disabled="true">Disabled</a></li>
                            </ul>
    ...
    &lt;/div&gt;</code>
                ...
                <h3 id="image-caps">Image caps<a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon="#"
                        href="#image-caps" style="padding-left: 0.375em;"></a></h3>
                <p>Similar to headers and footers, cards can include top and bottom “image caps”—images at the top or
                    bottom of a card.</p>
                <div class="bd-example mb-5">
                    <div class="card mb-3">
                        <img class="card-img-top"
                            src="{!! asset('public/backend/dist/assets/images/gallery/10.jpg') !!}" alt="" />
                    ...
                    <div class="card">
                        ...
                        <img class="card-img-top" src="{!! asset('public/backend/dist/assets/images/gallery/8.jpg') !!}"
                            alt="" />

                    </div>
                    <pre>
    <code class="language-html" data-lang="html">&lt;div class=&quot;card mb-3&quot;&gt;
        &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/10.jpg') !!}&quot; alt=&quot;&quot; /&gt;
    ...
    &lt;div class=&quot;card&quot;&gt;
        &lt;div class=&quot;card-body&quot;&gt;
            ...
            &lt;p class=&quot;card-text&quot;&gt;&lt;small class=&quot;text-muted&quot;&gt;Last updated 3 mins ago&lt;/small&gt;&lt;/p&gt;
        &lt;/div&gt;
        &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/8.jpg') !!}&quot; alt=&quot;&quot; /&gt;
                ...
                <div class="bd-example mb-5">
                    <div class="card mb-3">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="card-img-top"
                                    src="{!! asset('public/backend/dist/assets/images/gallery/5.jpg') !!}" alt="" />
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
    ...
    <code class="language-html" data-lang="html">&lt;div class=&quot;card mb-3&quot; style=&quot;max-width: 540px;&quot;&gt;
        &lt;div class=&quot;row g-0&quot;&gt;
            &lt;div class=&quot;col-md-4&quot;&gt;
                &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/5.jpg') !!}&quot; alt=&quot;&quot; /&gt;
            &lt;/div&gt;
            &lt;div class=&quot;col-md-8&quot;&gt;
                &lt;div class=&quot;card-body&quot;&gt;
                    &lt;h5 class=&quot;card-title&quot;&gt;Card title&lt;/h5&gt;
    ...
    &lt;/div&gt;</code>
                ...
                <p>Use <a href="https://v5.getbootstrap.com/docs/5.0/utilities/colors/">text and background
    ...
    &lt;/div&gt;</code>
                ...
                <div class="card shadow-sm p-3">
                    <h5 id="conveying-meaning-to-assistive-technologies">Conveying meaning to assistive technologies
                    </h5>
                    <p>Using color to add meaning only provides a visual indication, which will not be conveyed to users
                        ...
                        alternative means, such as additional text hidden with the <code>.visually-hidden</code> class.
                    </p>
                </div>

                <h3 id="border">Border</h3>
                <p>Use <a href="https://v5.getbootstrap.com/docs/5.0/utilities/borders/">border utilities</a> to change
                    just the <code>border-color</code> of a card. Note that you can put <code>.text-{color}</code>
                    classes on the parent <code>.card</code> or a subset of the card’s contents as shown below.</p>
                <div class="bd-example mb-5">
    ...
    &lt;/div&gt;</code>
                ...
                <p>You can also change the borders on the card header and footer as needed, and even remove their
                    <code>background-color</code> with <code>.bg-transparent</code>.
                </p>
                <div class="bd-example mb-5">
                    <div class="card border-success mb-3" style="max-width: 18rem;">
    ...
    &lt;/div&gt;</code>
                ...
                <div class="bd-example mb-5">
                    <div class="card-group">
                        <div class="card">
                            <img class="card-img-top"
                                src="{!! asset('public/backend/dist/assets/images/gallery/6.jpg') !!}" alt="" />
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <p class="card-text">This is a wider card with supporting text below as a natural
                                    lead-in to additional content. This content is a little bit longer.</p>
                        ...
                        <div class="card">
                            <img class="card-img-top"
                                src="{!! asset('public/backend/dist/assets/images/gallery/2.jpg') !!}" alt="" />
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
    ...
    &lt;/div&gt;</code>
                ...
                <div class="bd-example mb-5">
                    <div class="card-group">
                        ...
                        <div class="card">
                            <img class="card-img-top"
                                src="{!! asset('public/backend/dist/assets/images/gallery/8.jpg') !!}" alt="" />
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <p class="card-text">This is a wider card with supporting text below as a natural
                                    lead-in to additional content. This card has even longer content than the first to
    ...
    &lt;/div&gt;</code>
                ...
                <p>Use the Bootstrap grid system and its <a
                        href="https://v5.getbootstrap.com/docs/5.0/layout/grid/#row-columns"><code>.row-cols</code>
                        classes</a> to control how many grid columns (wrapped around your cards) you show per row. For
                    example, here’s <code>.row-cols-1</code> laying out the cards on one column, and
                    <code>.row-cols-md-2</code> splitting four cards to equal width across multiple rows, from the
                ...
                <div class="bd-example mb-5">
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                        <div class="col">
                            <div class="card">
                                <img class="card-img-top"
                                    src="{!! asset('public/backend/dist/assets/images/gallery/1.jpg') !!}" alt="" />
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                        ...
                        <div class="col">
                            <div class="card">
                                <img class="card-img-top"
                                    src="{!! asset('public/backend/dist/assets/images/gallery/9.jpg') !!}" alt="" />
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">This is a longer card with supporting text below as a natural
                                        lead-in to additional content. This content is a little bit longer.</p>
                        ...
                        <div class="col">
                            <div class="card">
                                <img class="card-img-top"
                                    src="{!! asset('public/backend/dist/assets/images/gallery/3.jpg') !!}" alt="" />
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">This is a longer card with supporting text below as a natural
                                        lead-in to additional content. This content is a little bit longer.</p>
    ...
    <code class="language-html" data-lang="html">&lt;div class=&quot;row row-cols-1 row-cols-md-2 g-4&quot;&gt;
        ...
        &lt;div class=&quot;col&quot;&gt;
            &lt;div class=&quot;card&quot;&gt;
                &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/9.jpg') !!}&quot; alt=&quot;&quot; /&gt;
                &lt;div class=&quot;card-body&quot;&gt;
                    &lt;h5 class=&quot;card-title&quot;&gt;Card title&lt;/h5&gt;
                    &lt;p class=&quot;card-text&quot;&gt;This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.&lt;/p&gt;
                &lt;/div&gt;
        ...
        &lt;div class=&quot;col&quot;&gt;
            &lt;div class=&quot;card&quot;&gt;
                &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/3.jpg') !!}&quot; alt=&quot;&quot; /&gt;
                &lt;div class=&quot;card-body&quot;&gt;
                    &lt;h5 class=&quot;card-title&quot;&gt;Card title&lt;/h5&gt;
                    &lt;p class=&quot;card-text&quot;&gt;This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.&lt;/p&gt;
                &lt;/div&gt;
    ...
    &lt;/div&gt;</code>
                ...
                <p>When you need equal height, add <code>.h-100</code> to the cards. If you want equal heights by
                    default, you can set <code>$card-height: 100%</code> in Sass.</p>
                <div class="bd-example mb-5">
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <img class="card-img-top"
                                    src="{!! asset('public/backend/dist/assets/images/gallery/7.jpg') !!}" alt="" />
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">This is a longer card with supporting text below as a natural
                                        lead-in to additional content.</p>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <img class="card-img-top"
                                    src="{!! asset('public/backend/dist/assets/images/gallery/4.jpg') !!}" alt="" />
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">This is a longer card with supporting text below as a natural
                                        lead-in to additional content. This content is a little bit longer.</p>
    ...
    <code class="language-html" data-lang="html">&lt;div class=&quot;row row-cols-1 row-cols-md-3 g-4&quot;&gt;
        ...
        &lt;div class=&quot;col&quot;&gt;
            &lt;div class=&quot;card h-100&quot;&gt;
                &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/7.jpg') !!}&quot; alt=&quot;&quot; /&gt;
                &lt;div class=&quot;card-body&quot;&gt;
                    &lt;h5 class=&quot;card-title&quot;&gt;Card title&lt;/h5&gt;
                    &lt;p class=&quot;card-text&quot;&gt;This is a longer card with supporting text below as a natural lead-in to additional content.&lt;/p&gt;
                &lt;/div&gt;
        ...
        &lt;div class=&quot;col&quot;&gt;
            &lt;div class=&quot;card h-100&quot;&gt;
                &lt;img class=&quot;card-img-top&quot; src=&quot;{!! asset('public/backend/dist/assets/images/gallery/4.jpg') !!}&quot; alt=&quot;&quot; /&gt;
                &lt;div class=&quot;card-body&quot;&gt;
                    &lt;h5 class=&quot;card-title&quot;&gt;Card title&lt;/h5&gt;
                    &lt;p class=&quot;card-text&quot;&gt;This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.&lt;/p&gt;
                &lt;/div&gt;
    ...
    &lt;/div&gt;</code>
                ...
                <p>In <code>v4</code> we used a CSS-only technique to mimic the behavior of <a
                        href="https://masonry.desandro.com/">Masonry</a>-like columns, but this technique came with lots
                    of unpleasant <a href="https://github.com/twbs/bootstrap/pull/28922">side effects</a>. If you want
                    to have this type of layout in <code>v5</code>, you can just make use of Masonry plugin.
                    <strong>Masonry is not included in Bootstrap</strong>, but we’ve made a <a
                        href="https://v5.getbootstrap.com/docs/5.0/examples/masonry/">demo example</a> to help you get
                    started.
                </p>
            </div>
