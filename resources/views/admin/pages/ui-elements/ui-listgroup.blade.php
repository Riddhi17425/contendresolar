...
<div class="container">
    <div class="col-12">
        <div class="bd-content">
            ...
            <h1>List group</h1>
            <p>List groups are a flexible and powerful component for displaying a series of content. Modify and extend
                them to support just about any content within.</p>
            <div class="alert alert-danger" role="alert">
                <strong>List group</strong> for more bootstrao components <a
                    href="https://v5.getbootstrap.com/docs/5.0/components/list-group/" target="_blank">Bootstrap List
                    group documentation <i class="fa fa-external-link"></i></a>
            </div>
    ...
    &lt;/ul&gt;</code>
                ...
                <ul class="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
                    <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#nav-Preview1b"
                            role="tab">Preview</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#nav-HTML1b" role="tab">HTML</a>
                    </li>
                </ul>
                <div class="card mb-3 bg-transparent">
                    <div class="card-body">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        ...
                                        <ul class="list-unstyled list-group list-group-custom list-group-flush mb-0">
                                            <li class="list-group-item px-md-4 py-3">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <img class="avatar rounded-circle"
                                                        src="{!! asset('public/backend/dist/assets/images/xs/avatar1.svg') !!}"
                                                        alt="">
                                                    <div class="flex-fill ms-3 text-truncate">
                                                        <h6 class="d-flex justify-content-between mb-0"><span>Chris
                                                                Fox</span></h6>
                                            ...
                                            <li class="list-group-item px-md-4 py-3">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <img class="avatar rounded-circle"
                                                        src="{!! asset('public/backend/dist/assets/images/xs/avatar4.svg') !!}"
                                                        alt="">
                                                    <div class="flex-fill ms-3 text-truncate">
                                            ...
                                            <li class="list-group-item px-md-4 py-3">
                                                <a href="javascript:void(0);" class="d-flex">
                                                    <img class="avatar rounded-circle"
                                                        src="{!! asset('public/backend/dist/assets/images/xs/avatar5.svg') !!}"
                                                        alt="">
                                                    <div class="flex-fill ms-3 text-truncate">
                                                        <h6 class="d-flex justify-content-between mb-0"><span>Robert
                                                                Hammer</span></h6>
                                        ...
                                        <ul class="list-unstyled list-group list-group-custom list-group-flush mb-0">
                                            <li class="list-group-item d-flex py-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-0">7 New Feedback <small
                                                            class="float-right text-muted">Today</small></h6>
                                            ...
                                            <li class="list-group-item d-flex py-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-0">New User <small
                                                            class="float-right text-muted">10:45</small></h6>
                                            ...
                                            <li class="list-group-item d-flex py-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-0 text-warning">Server Warning <small
                                                            class="float-right text-muted">10:50</small></h6>
                                            ...
                                            <li class="list-group-item d-flex py-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-0 text-danger">Issue Fixed <small
                                                            class="float-right text-muted">11:05</small></h6>
                                            ...
                                            <li class="list-group-item d-flex py-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-0">7 New Orders <small
                                                            class="float-right text-muted">11:35</small></h6>
                                        ...
                                        <ul class="list-unstyled list-group list-group-custom list-group-flush mb-0">
                                            <li class="list-group-item d-flex align-items-center py-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label ms-2" for="list-group1">Front
                                                        Door</label>
                                                </div>
                                            </li>
                                            <li class="list-group-item d-flex align-items-center py-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="list-group2"
                                                        checked="">
                                                    <label class="form-check-label ms-2" for="list-group2">Air
                                                        Conditioner</label>
                                                </div>
                                            </li>
                                            <li class="list-group-item d-flex align-items-center py-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label ms-2" for="list-group3">Enable RTL
                                                        Mode!</label>
                                                </div>
                                            </li>
                                            <li class="list-group-item d-flex align-items-center py-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label ms-2" for="list-group4">Front
                                                        Door</label>
                                                </div>
                                            </li>
                                            <li class="list-group-item d-flex align-items-center py-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label ms-2" for="list-group5">Air
                                                        Conditioner</label>
                                                </div>
                                            </li>
                                            <li class="list-group-item d-flex align-items-center py-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="list-group6"
                                                        checked="">
                                                    <label class="form-check-label ms-2" for="list-group6">Washing
                                                        Machine</label>
                                                </div>
                                            </li>
                                        </ul>
    ...
    &lt;/ul&gt;</code>
                ...
                <p class="mb-0">Add <code>.active</code> to a <code>.list-group-item</code> to indicate the current
                    active selection.</p>
    ...
    &lt;/ul&gt;</code>
            ...
            <div class="border-top mt-5 pt-3">
                ...
                <p>Contextual classes also work with <code>.list-group-item-action</code>. Note the addition of the
                    hover styles here not present in the previous example. Also supported is the <code>.active</code>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="list-group">
                                            <a href="javascript:void(0);" class="list-group-item list-group-item-action">Dapibus ac
                                                facilisis in</a>
