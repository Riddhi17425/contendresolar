...
<body style="margin:0; padding:0; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%;">
    <center>
        <table cellpadding="0" cellspacing="0" border="0" width="100%"
            ...
            <tr>
                <td>
                    <img src="{{ asset('public/front/images/email-banner.png') }}" alt="banner"
            ...
            <tr>
                <td class="text-center1"
                    ...
                    <p style=" font-size: 14px; line-height: 20px;">
                        Hello Team,<br>
                        A new career-related submission has been received through the Contendre Solar website.<br>
                        Please find the applicant’s details below for review and further action.
                    </p>
                </td>
            </tr>
            <tr>
                <td class="text-center2" style="padding: 0 48px 37px 48px">
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">Position :</td>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['position'] }}</td>
                            </tr>
