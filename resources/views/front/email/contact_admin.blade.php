            ...
            <tr>
                <td class="text-center1"
                    ...
                    <p style=" font-size: 14px; line-height: 20px;">
                        Hello Team,<br>
                         You have received a new contact enquiry through the Contendre Solar website.<br>
                         Please find the customer details below for further action.
                    </p>
                </td>
            </tr>
            <tr>
                <td class="text-center2" style="padding: 0 48px 37px 48px">
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">Organization :</td>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['organization'] }}</td>
                            </tr>
                            <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">Requirements :</td>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['requirement'] }}</td>
                            </tr>
                            <tr>
