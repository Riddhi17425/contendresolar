            ...
            <tr>
                <td class="text-center1"
                    ...
                    <p style=" font-size: 14px; line-height: 20px;">
                        Hello Team,<br>
                            A new consulting request has been submitted via the Contendre Solar website.<br>
                            The customer is seeking expert guidance and support. Details are shared below.
                    </p>
                </td>
            </tr>
            <tr>
                <td class="text-center2" style="padding: 0 48px 37px 48px">
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">KiloWatt :</td>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['kilowatt'] }}</td>
                            </tr>
                            <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">Query :</td>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['qry'] }}</td>
                            </tr>
                            <tr>
