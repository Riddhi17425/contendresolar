            ...
            <tr>
                <td class="text-center1"
                    ...
                    <p style=" font-size: 14px; line-height: 20px;">
                         Hello Team,<br>
                            A service support request has been raised through the Contendre Solar website.<br>
                            Please find the submitted details below.
                    </p>
                </td>
            </tr>
            <tr>
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['email'] }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">Product Name :</td>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['product_name'] }}</td>
                            </tr>
                            <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">Modal Number :</td>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['modal_number'] }}</td>
                            </tr>
                            <tr>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">City of Installation :</td>
                                <td style=" border: 1px solid #DDD;padding:9px 8px 8px 23px;">{{ $data['city_installation'] }}</td>
                            </tr>
